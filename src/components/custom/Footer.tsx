import { footerData } from "@/lib/footerContactData"
import { ExternalLink } from "lucide-react"

const { email, socialLinks } = footerData;
                ...
                <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
                    ...
                    <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
                        ...
                        <p className="max-w-md text-base sm:text-lg text-muted-foreground leading-relaxed">
                            If you liked my portfolio, why not contact me and we can arrange to work together? My contact information is below; please reach out if you're interested in working with me or giving me a formal job offer.
                        </p>
