...
const socialLinks = [
    { label: "GitHub", href: "https://github.com/Samu31Nd", icon: Github },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/eduardo-samuel-sanchez-leyva-729634219/", icon: Linkedin },
];
